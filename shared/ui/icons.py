...
from shared.utils.assets import get_app_logo_path
...
class Icons:
    ...
    _SVG_ICONS: Dict[str, str] = {
        ...
        "bookmark": '''<svg viewBox="0 0 24 24"><path fill="{color}" d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z"/></svg>''',
    }
